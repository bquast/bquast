...
## Current projects
- [llama.go](https://bquast.github.io/llama.go) ([repo](https://github.com/bquast/llama.go)) - llama inference engine in Go, compile to wasm, runs locally in the browser
