...
- [simple-agent-harness](https://github.com/bquast/simple-agent-harness) - an bare-bones AI agent harnass (like OpenClaw 🦞), using a local LLM via Ollama (default Gemma4).
