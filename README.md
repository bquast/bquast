...
- [autoresearch-mesa](https://github.com/bquast/autoresearch-mesa) - an adaptation of Karpathy's autoresearch, in turn an OpenClaw 🦞 style AI agent to explore hyperparameters. Uses the python ABM framework [mesa](https://github.com/mesa).
